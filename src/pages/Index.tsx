...
const heroCategories = [
  ...
  { name: "Grab & Go", image: "https://vibe.filesafe.space/1782359074813107391/attachments/eb7ec6d8-d4e7-4f35-af17-289e293329b4.png", link: "/pre-order" },
];
    ...
    <div className="flex flex-col w-full">
      ...
      <section ref={discoverRef} className="bg-background border-b-2 border-primary relative">
        <div className="flex flex-col md:flex-row w-full min-h-screen">
            ...
            <motion.div style={{ y: discoverY }} className="w-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild variant="outline" className="px-8 py-6 rounded-none text-xs font-bold tracking-widest uppercase">
                  <Link to="/catering">VIEW CATALOG</Link>
                </Button>
          ...
          {/* Right Side (Desktop Scrollable / Mobile Carousel) */}
          <div className="w-full md:w-1/2">
            ...
            <div className="md:hidden p-4">
              <Carousel opts={{ align: "start" }} className="w-full">
                <CarouselContent className="-ml-4">
                  {[
                    { title: "WEDDING CAKES", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/10a71050-16bc-405f-af35-634769e62040.jpg" },
                    { title: "LARGE ENTREMETS", link: "/catering", img: "https://vibe.filesafe.space/1782359074813107391/assets/d6f84bdb-d0b7-4088-b4e0-eede3feb4e6c.png" },
                    { title: "SWEET COCKTAIL PIECES", link: "/contact", img: "https://vibe.filesafe.space/1782359074813107391/assets/520e8b0a-5e74-40ed-9fdf-65565b107cb7.png" },
                    { title: "SAVORY COCKTAIL PIECES", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/892503fb-424e-4d41-9419-88f00f047ebb.png" }
                  ].map((item, i) => (
                    <CarouselItem key={i} className="pl-4 basis-[85%] sm:basis-[70%]">
                      <Link to={item.link} className="group block relative h-[60vh] border-2 border-primary bg-card overflow-hidden">
                        <img src={item.img} alt={item.title} className="absolute inset-0 w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500 group-hover:scale-105" />
            ...
            <div className="hidden md:grid grid-cols-2">
              {[
                { title: "PIÈCE MONTÉE", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/10a71050-16bc-405f-af35-634769e62040.jpg", span: "col-span-2", aspect: "aspect-[4/3]" },
                { title: "GRAND ENTREMETS", link: "/catering", img: "https://vibe.filesafe.space/1782359074813107391/assets/d6f84bdb-d0b7-4088-b4e0-eede3feb4e6c.png", span: "col-span-1", aspect: "aspect-[3/4]" },
                { title: "PIÈCES COCKTAILS SUCRÉES", link: "/contact", img: "https://vibe.filesafe.space/1782359074813107391/assets/520e8b0a-5e74-40ed-9fdf-65565b107cb7.png", span: "col-span-1", aspect: "aspect-[3/4]" },
                { title: "PIÈCES COCKTAILS SALÉES", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/892503fb-424e-4d41-9419-88f00f047ebb.png", span: "col-span-2", aspect: "aspect-[4/3]" },
                { title: "ECLAIRS", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/dbaf613c-3e6b-45e0-af7a-e278e2d1a6df.png", span: "col-span-1", aspect: "aspect-[3/4]" },
                { title: "GRAB & GO", link: "/pre-order", img: "https://vibe.filesafe.space/1782359074813107391/attachments/eb7ec6d8-d4e7-4f35-af17-289e293329b4.png", span: "col-span-1", aspect: "aspect-[3/4]" },
                { title: "BUFFET", link: "/catering", img: "https://vibe.filesafe.space/1782359074813107391/attachments/4d6440a1-b606-44aa-850a-5251c77f02af.png", span: "col-span-2", aspect: "aspect-[4/3]" }
              ].map((item, i) => {
                const isLeftColumnSmall = item.span === 'col-span-1' && (i === 1 || i === 4);
                return (
                  <Link key={i} to={item.link} className={`group block relative border-b-2 border-primary ${isLeftColumnSmall ? 'border-r-2' : ''} ${item.span} overflow-hidden`}>
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] border-b-2 border-primary overflow-hidden flex items-center justify-center">
        ...
        <AnimatedSection className="relative z-10 flex flex-col items-center text-center text-white px-4">
          ...
          <Button asChild variant="outline" className="bg-transparent text-white border-white hover:bg-white hover:text-primary rounded-none px-8 py-6 text-xs md:text-sm tracking-widest uppercase transition-all duration-300">
            <Link to="/contact">VIEW ADDRESS</Link>
          </Button>
        </AnimatedSection>
      </section>
        ...
        <AnimatedSection className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-center text-center mt-28 md:mt-16">
          <div className="w-full md:w-2/3 flex flex-col items-center">
            ...
            <Button asChild size="lg" className="bg-background text-primary hover:bg-transparent hover:text-background hover:border-background hover:-translate-y-1 hover:shadow-[4px_4px_0_0_hsl(var(--background))] text-sm font-bold uppercase tracking-widest rounded-none border-2 border-transparent px-8 py-6 md:px-12 md:py-6 transition-all duration-300 w-full sm:w-auto">
              <Link to="/join-team">Apply Here</Link>
            </Button>
          </div>
        </AnimatedSection>
      </section>
