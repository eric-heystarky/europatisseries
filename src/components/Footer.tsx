...
import { Bike, Store, MapPin, Lock, ArrowRight, Instagram } from "lucide-react";
    ...
    <footer className="border-t-2 border-primary bg-background text-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-b-2 border-primary">
        <div className="flex flex-col items-center text-center p-12 border-b-2 md:border-b-0 md:border-r-2 border-primary">
          ...
          <p className="text-sm pfont-medium opacity-80">By courier</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm font-medium opacity-80">
              <Link to="/contact" className="hover:opacity-100 transition-opacity">Armadale</Link>
              <a href="https://maps.google.com/?q=Euro+Patisserie+Armadale" target="_blank" rel="noreferrer" className="mt-2 text-xs font-bold underline underline-offset-4 hover:opacity-70 transition-opacity">
                VIEW ON MAP
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <Link to="/join-team" className="text-sm font-medium underline underline-offset-4 hover:opacity-70 transition-opacity">careers@europatisserie.com.au</Link>
            </div>
          ...
          <div>
            ...
            <form className="flex gap-4 mb-6" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <Button type="submit" className="rounded-none border-2 border-primary bg-primary text-primary-foreground hover:bg-transparent hover:text-primary px-8 font-bold tracking-widest uppercase text-xs">
                SUBSCRIBE
              </Button>
            </form>
            ...
            <p className="text-xs font-medium opacity-60 leading-relaxed">
              By clicking on subscribe, I wish to subscribe to the newsletter and receive by email the latest creations, promotions and news of Euro Patisserie and I accept the Privacy Policy and acknowledge I can unsubscribe at any time.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center pb-16 gap-6">
        ...
        <p className="text-xs font-medium opacity-60 uppercase tracking-widest">
          Powered by <a href="https://heystarky.com.au" target="_blank" rel="noreferrer" className="underline underline-offset-4 hover:opacity-100 transition-opacity">HeyStarky AU</a>
        </p>
      </div>
    </footer>
  );
