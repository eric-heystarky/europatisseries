        ...
        >
          ...
          >
            <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none">
              <path id="loadingWavePath" d="M 0 150 Q 250 50 500 150 T 1000 150 T 1500 150 T 2000 150" fill="transparent" stroke="transparent" />
              <text className="font-sans text-5xl md:text-8xl font-black uppercase tracking-widest text-primary-foreground" fill="currentColor">
